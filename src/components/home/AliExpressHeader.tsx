...
export default function AliExpressHeader({ activeTabId = 'recommendations' }: AliExpressHeaderProps) {
  ...
  const categories = [
    ...
    { id: 'electronics', name: 'Electronics & Tech', icon: <Tv className="h-3 w-3" />, path: '/categories/electronics' },
    { id: 'home', name: 'Home & Living', icon: <Sofa className="h-3 w-3" />, path: '/categories/home-living' },
    { id: 'fashion', name: 'Fashion & Accessories', icon: <ShoppingBag className="h-3 w-3" />, path: '/categories/fashion' },
    { id: 'entertainment', name: 'Entertainment', icon: <Gamepad2 className="h-3 w-3" />, path: '/categories/entertainment' },
    { id: 'kids', name: 'Kids & Hobbies', icon: <ShoppingCart className="h-3 w-3" />, path: '/categories/kids-hobbies' },
    { id: 'sports', name: 'Sports & Outdoors', icon: <ShoppingBag className="h-3 w-3" />, path: '/categories/sports-outdoors' },
    { id: 'automotive', name: 'Automotive', icon: <Car className="h-3 w-3" />, path: '/categories/automotive' },
  ];
